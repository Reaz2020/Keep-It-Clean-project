...
public class ResourceAlreadyExistException extends InvalidConfigurationPropertyValueException {
    /**
     ...
     */
    public ResourceAlreadyExistException(String name, Object value, String reason) {
